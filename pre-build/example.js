...
([
    ...
    (function (module, exports, __webpack_require__) {
        ...
        console.log("dyy js_page exec 1");
        ...
        console.log("dyy js_page exec 2");
        ...
        function jumpTo(url, title, lang) {
            getLanguage(function (language) {
                ...
                navigator.push({
                    url: createURL('bf0305c14b511b24a4e616f53926432b', {
                        language: language,
        ...
        function viewSource(hash) {
            getLanguage(function (language) {
                navigator.push({
                    url: createURL('f6ce29faf686eabc38b410bf4828fa5a', {
                        hash: hash,
                        language: language
                    })
                });
        ...
        console.log("dyy js_page exec 3");
            ...
            try {
                stream.fetch({
                    ...
                    if (res.ok && res.data && res.data.success) {
                        console.log("fetch success" + JSON.stringify(res.data));
                        done(res.data);
                    } else {
    ...
    (function (module, exports, __webpack_require__) {
        ...
        exports.default = {
            components: {
                ExampleScroller: _ExampleScroller2.default
            },
            data: function data() {
                return {
            ...
            beforeCreate: function beforeCreate() {
                var _this = this;
                console.log("fetch beforeCreate = ");
                ...
                (0, _utils.fetchExamples)(function (result) {
                    (0, _utils.saveExamples)(result);
                        ...
                        console.log("fetch done = " + JSON.stringify(_this.examples));
                });

                setTimeout(function () {
                    console.log(" setTimeout fetch map" + JSON.stringify(_this.examples));
            ...
            computed: {
                tabs: function tabs() {
                    console.log("fetch map = " + this.examples);
...
console.log("dyy js_page exec finished");