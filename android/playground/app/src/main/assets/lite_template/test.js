...
__print("IDS pre: ",JSON.stringify(__getLastCallbackIds()));
__print("TST: ",require("@weex-module/searchEvent").test((p)=>(__print("callback p:",p))));
__print("IDS: ",JSON.stringify(__getLastCallbackIds()));
__print("TST: ",require("@weex-module/searchEvent").test((p)=>(__print("callback p:",p))));
__print("IDS: ",JSON.stringify(__getLastCallbackIds()));
__print("TST: ",require("@weex-module/searchEvent").test((p)=>(__print("callback p:",p))));
__print("IDS: ",JSON.stringify(__getLastCallbackIds()));

require("@weex-module/searchEvent").search();
