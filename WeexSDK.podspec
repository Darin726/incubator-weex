...
Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = { 'USER_HEADER_SEARCH_PATHS' => '${PODS_ROOT}/WeexSDK/weex_core/Source/ ${PROJECT_DIR}/../../../weex_core/Source ${PROJECT_DIR}/../../../weex_core/Source/qking ${PROJECT_DIR}/../../weex/weex_core/Source ${PROJECT_DIR}/../../weex/weex_core/Source/qking', 'GCC_PREPROCESSOR_DEFINITIONS[config=Debug]' => 'OS_IOS=1 QKING_ENABLE_EXTERNAL_WEEX_ENV QKING_ENABLE_EXTERNAL_CONTEXT QKING_ENABLE_ERROR_MESSAGES QKING_ENABLE_LOGGING JMEM_STATS CONFIG_DISABLE_COMPILER_BUILTIN',  'GCC_PREPROCESSOR_DEFINITIONS[config=Release]' => 'OS_IOS=1 QKING_ENABLE_EXTERNAL_CONTEXT QKING_ENABLE_EXTERNAL_WEEX_ENV QKING_NDEBUG CONFIG_DISABLE_COMPILER_BUILTIN' }
