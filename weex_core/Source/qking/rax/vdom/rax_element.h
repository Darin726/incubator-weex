...
class RaxElement {
 public:
  ...
  bool is_mount_to_root();

  RaxElement *get_parent_root();
  ...
  inline RaxElement *get_comp_owner() { return comp_owner_; }
  ...
  inline void set_comp_owner(RaxElement *parent) { comp_owner_ = parent; }

  inline void set_comp_render_parent(native_node_ptr parent) {
    comp_render_parent_ = parent;
  }

  inline bool is_composite_component() {
    return type_ == RaxElementType::kClass ||
           type_ == RaxElementType::kFunction;
  }

  inline bool is_native_holder_component() {
    return type_ == RaxElementType::kNative || type_ == RaxElementType::kText ||
           type_ == RaxElementType::kRoot;
  }

  inline bool is_props_holder_component() {
    return type_ == RaxElementType::kNative || type_ == RaxElementType::kRoot;
  }

  inline void set_comp_mounted(bool flag) { comp_mounted_ = flag; }
 ...
 private:
  ...
  RaxElement *comp_owner_ = nullptr;
