...
class RaxNativeElement : public RaxNativeNodeHolder, public RaxPropsHolder {
 public:
  ...
  inline std::string &actrual_comp_type() { return actrual_comp_type_; }
