...
bool
qking_value_is_nan (const qking_value_t value) /**< api value */
{
  qking_assert_api_available ();

  return ecma_is_value_number(value) && ecma_number_is_nan (ecma_get_number_from_value(value));
} /* qking_value_is_null_or_undefined */
 ...
 */
qking_value_t
qking_create_string_from_utf8_c (const char *str_p) /**< pointer to string */
{
  return qking_create_string_sz_from_utf8 ((const qking_char_t *)str_p, lit_zt_utf8_string_size ((lit_utf8_byte_t *) str_p));
} /* qking_create_string_from_utf8 */
                  ...
                  qking_size_t string_size) /**< json string size */
{
  qking_assert_api_available ();
#ifndef CONFIG_DISABLE_JSON_BUILTIN
  ecma_string_t *ecma_str_p = ecma_new_ecma_string_from_utf8_converted_to_cesu8 ((lit_utf8_byte_t *) string_p,
                                                                                 (lit_utf8_size_t) string_size);


  ECMA_STRING_TO_UTF8_STRING (ecma_str_p, conv_str_utf8_p, conv_str_size);
  ecma_value_t ret_value = ecma_builtin_json_parse_buffer (conv_str_utf8_p, conv_str_size);
  ecma_deref_ecma_string(ecma_str_p);
