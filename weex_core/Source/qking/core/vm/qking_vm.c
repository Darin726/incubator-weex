...
static ecma_value_t ecma_func_call(vm_frame_ctx_t *frame_ctx_p, ecma_register_t *func,
                           const uint32_t argc) {
  ecma_value_t completion_value = ECMA_VALUE_EMPTY;
    ...
    while (pc != pc_end) {
      ...
      switch (op) {
        ...
        case OP_GET_GLOBAL: {
          ...
          QKING_TO_LOG_STR_FINISH(debug_print_str);
#endif
          ecma_value_t final_value = ecma_op_object_get(
              global_obj, ecma_get_string_from_value(prop_name_val));
          if (final_value == ECMA_VALUE_UNDEFINED) {
#ifdef QKING_ENABLE_ERROR_MESSAGES
        ...
        case OP_GET_LOCAL: {
          ...
          const ecma_value_t prop_name_val =
              qking_get_property_by_index(constants, idxB);
          a = registers_p + idxA;
          ecma_value_t final_value = ecma_op_get_binding_value(
              frame_ctx_p->lex_env_p, ecma_get_string_from_value(prop_name_val),
              false);
          CHECK_COMPLETION_VALUE(final_value);
          ecma_fast_free_value(a->var);
          a->var = final_value;
          vm_sync_closure(a);
          ecma_fast_free_value(prop_name_val);
        ...
        case OP_CONSTRUCTOR: {
          ...
          c = registers_p + idxC;
          ecma_value_t final_value;
          if (!ecma_op_is_callable(c->var)) {
            final_value = ecma_raise_type_error(ECMA_ERR_MSG("Expected a function."));
          } else {
            switch (op) {
              case OP_CALL: {
            ...
            LOGD("\n======================> FUNC START");
            final_value = ecma_func_call(frame_ctx_p, c, argc);
            LOGD("FUNC RETURN <=====================\n");
          }
          CHECK_COMPLETION_VALUE(final_value);
          ecma_fast_free_value(a->var);
        ...
        case OP_GET_SUPER: {
          ...
          switch (idxB) {
            ...
            case VM_OP_GET_SUPER_TYPE_PROTOTYPE: {
              ...
              final_value = ecma_fast_copy_value(super_prototype);
              break;
            }
            case VM_OP_GET_SUPER_TYPE_FUNCTION_THIS: {
              final_value = ecma_fast_copy_value(frame_ctx_p->this_function);
              break;
            }
            default:
        ...
        case OP_EQUAL: {
          ...
          b = registers_p + idxB;
          c = registers_p + idxC;
          ecma_value_t final_value = opfunc_equality(b->var, c->var);
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_INSTANCEOF: {
          ...
          ecma_value_t final_value = opfunc_instanceof(b->var, c->var);
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_TYPEOF: {
          ...
          ecma_value_t final_value = opfunc_typeof(b->var);
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_ADD: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
          ...
          }else if (ecma_is_value_float_number(lhs) && ecma_is_value_number(rhs)) {
            ecma_number_t new_value = (ecma_get_float_from_value(lhs) +
                                       ecma_get_number_from_value(rhs));
            final_value = ecma_make_number_value(new_value);
          } else if (ecma_is_value_float_number(rhs) &&
            ...
            final_value = opfunc_addition(lhs, rhs);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_MUL: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            if (-ECMA_INTEGER_MULTIPLY_MAX <= left_integer &&
                ...
                rhs != 0) {
              final_value = ecma_integer_multiply(left_integer, right_integer);
            } else {
              ecma_number_t multiply =
                  (ecma_number_t)left_integer * (ecma_number_t)right_integer;
              final_value = ecma_make_number_value(multiply);
            }
          } else if (ecma_is_value_float_number(lhs) && ecma_is_value_number(rhs)) {
            ecma_number_t new_value = (ecma_get_float_from_value(lhs) *
                                       ecma_get_number_from_value(rhs));
        ...
        case OP_DIV: {
          ...
          ecma_value_t final_value = do_number_arithmetic(NUMBER_ARITHMETIC_DIVISION, lhs, rhs);
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_MOD: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            if (right_integer != 0) {
              ...
              if (mod_result != 0 || left_integer >= 0) {
                final_value = ecma_make_integer_value(mod_result);
          ...
          final_value = do_number_arithmetic(NUMBER_ARITHMETIC_REMAINDER, lhs, rhs);
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_LESS: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            final_value = ecma_make_boolean_value(is_less);
          } else if (ecma_is_value_number(lhs) && ecma_is_value_number(rhs)) {
            ecma_number_t left_number = ecma_get_number_from_value(lhs);
            ecma_number_t right_number = ecma_get_number_from_value(rhs);
            final_value = ecma_make_boolean_value(left_number < right_number);
          } else {
            final_value = opfunc_relation(lhs, rhs, true, false);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_GREATER: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            final_value = ecma_make_boolean_value(left_integer > right_integer);
          } else if (ecma_is_value_number(lhs) && ecma_is_value_number(rhs)) {
            ecma_number_t left_number = ecma_get_number_from_value(lhs);
            ecma_number_t right_number = ecma_get_number_from_value(rhs);
            final_value = ecma_make_boolean_value(left_number > right_number);
          } else{
            final_value = opfunc_relation(lhs, rhs, false, false);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_LESS_EQUAL: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            final_value = opfunc_relation(lhs, rhs, false, true);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_GREATER_EQUAL: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            final_value = opfunc_relation(lhs, rhs, true, true);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_POST_DECR: {
          ...
          if (is_post) {
            ecma_fast_free_value(b->var);
            b->var = ecma_fast_copy_value(ret);
            vm_sync_closure(b);
          }
        ...
        case OP_BIT_OR: {
          ...
          if (ecma_are_values_integer_numbers(lhs, lhs)) {
            ...
            final_value = do_number_bitwise_logic(NUMBER_BITWISE_LOGIC_OR, lhs, rhs);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_BIT_XOR: {
          ...
          QKING_STATIC_ASSERT(
              ...
              direct_type_mask_must_fill_all_bits_before_the_value_starts);
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            final_value = (lhs ^ rhs) & (ecma_value_t)(~ECMA_DIRECT_TYPE_MASK);
          } else {
            final_value = do_number_bitwise_logic(NUMBER_BITWISE_LOGIC_XOR, lhs, rhs);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_BIT_AND: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            final_value = do_number_bitwise_logic(NUMBER_BITWISE_LOGIC_AND, lhs, rhs);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_BIT_NOT: {
          ...
          if (ecma_is_value_integer_number(rhs)) {
            final_value = (~rhs) & (ecma_value_t)(~ECMA_DIRECT_TYPE_MASK);
          } else {
            final_value = do_number_bitwise_logic(NUMBER_BITWISE_NOT, rhs, rhs);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_LEFT_SHIFT: {
          ...
          if (ecma_are_values_integer_numbers(lhs, rhs)) {
            ...
            ecma_integer_value_t right_integer =
                ecma_get_integer_from_value(rhs);
            final_value = ecma_make_int32_value(
                (int32_t)(left_integer << (right_integer & 0x1f)));
          } else {
            final_value = do_number_bitwise_logic(NUMBER_BITWISE_SHIFT_LEFT, lhs, rhs);
          }
          CHECK_COMPLETION_VALUE(final_value);
        ...
        case OP_IN: {
          ...
          ecma_value_t lhs = b->var;
          ecma_value_t rhs = c->var;
          ecma_value_t final_value =opfunc_in(lhs, rhs);
        ...
        case OP_DELETE: {
          ...
          ecma_value_t final_value =vm_op_delete_var(b->var, frame_ctx_p->lex_env_p);
