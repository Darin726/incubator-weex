 ...
 *
 * v9: 2019/02/12
 * OP_GET_SUPER增加了一个type: VM_OP_GET_SUPER_TYPE_FUNCTION_THIS,
 * 用于获取当前的function object.
 *
 * v8: base
 * 基础版本
 * ----------------------------------------------------
...
// EXEC_BINARY_COMPATIBLE_VERSION 表明了binary文件编码的version,
...
#define EXEC_BINARY_COMPATIBLE_VERSION 9
