...
qking_value_t qking_create_string_from_utf8_c(const char *str_p);
...
bool qking_value_is_nan(const qking_value_t value);
...
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_VALUE;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_WIDTH;
extern const qking_magic_str_t QKING_LIT_MAGIC_STRING_EX_HEIGHT;
